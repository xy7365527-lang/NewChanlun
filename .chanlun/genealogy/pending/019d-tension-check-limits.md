...
**核心张力**：012（谱系是发现引擎 → 无限探索）vs 013（结构工位不应占据比任务工位更多资源 → 有限预算）。这两条已结算谱系之间存在未被辨认的张力。
...
3. 012 和 013 之间存在未辨认的张力：无限发现 vs 有限预算
4. ∴ 需要在"发现能力"和"操作约束"之间找到平衡点
5. 递归深度限制 + 范围策略 = 平衡点的工程实现

## 谱系链接

- **父**: 019-loop-breakpoint-coverage（本条是 019 的子发现 G5+G6）
- **前置**: 012-genealogy-is-discovery-engine（张力碰撞原则）
- **张力**: 013-swarm-structural-stations（结构工位资源约束 — **012与013之间的未辨认张力**）
