...
**核心张力**：012（谱系是发现引擎 → 无限探索）vs 013（结构工位不应占据比任务工位更多资源 → 有限预算）。这两条已结算谱系之间存在未被辨认的张力。**后续辨认（020号）**：此张力是谱系系统的构成性张力（对象a），不是待消解的矛盾。
...
3. 012 和 013 之间存在构成性张力（对象a）：无限发现 vs 有限预算（见020号谱系）
...
- **后续**: 020-constitutive-tension-objet-a（将本条识别的张力重新定性为构成性条件）
