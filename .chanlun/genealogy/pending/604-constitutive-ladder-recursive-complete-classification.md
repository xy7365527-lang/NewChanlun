...
id: "604"
number: 604
status: 生成态   # Phase 2 claim5 形式化结晶。依赖 603（范式根，生成态）+ 001/003（线段口径分离，已结算）+ Phase1 RecursiveConstruction（Move[0]=Segment 衔接）。最终编号 + 结算待 /ritual 在统一编号空间裁定（同 597-603 族）。
