...
> **[历时性补丁]** 135号否定了073b的核心前提（平台支持子蜂群递归），以下清单中 P0 项已失效。
> 审计RTAS受限项的物质原因从"平台不支持"变为"工程实现未完成"，缺口性质不变。

| # | 约束项 | 级别 | 状态 | 来源 |
|---|--------|------|------|------|
| P0 | subagent 不能 spawn sub-subagent | 硬约束 | **已否定**（135号） | 073b 原始前提 |
| P1 | 审计 RTAS 受限——当前审计为扁平模式，非递归拓扑 | 体系要求级 | 声明-能力缺口 | 130号下游推论 |
