...
|---|---|---|---|---|
| train | 219 | 2.1914e4 | 79/219 (36%) | 7.8186e4 |
| **holdout** | 128 | **7.8697e3** | 45/128 (35%) | 2.9633e4 |
| holdout 对照·买(δ+1) | 164 | -5.4184e4 | 42/164 (26%) | — |

**判定**：holdout level0卖 actual_pnl = 7.8697e3 > 0
...
|---|---|---|---|---|---|---|
| 1（前半） | -34.35% | 1.3782e4 | 177 | -5.7188e4 | 163 | 是 |
| 2（后半） | +8.51% | 1.2949e4 | 168 | -5.0910e4 | 198 | 是 |

**判定**：两个不重叠子窗 level0卖均优于买。
→ **结构性（跨涨跌都卖优）**：子窗1/子窗2 净涨跌符号相反（一涨一跌）卖仍都优 ⟹ 卖优势非单纯下跌段做空产物，是结构性方向不对称。L2 单标的。

## 结果包六要素
1. **结论**：holdout level0卖 actual_pnl=7.8697e3（OOS 初步稳健），方向不对称=结构性候选。
