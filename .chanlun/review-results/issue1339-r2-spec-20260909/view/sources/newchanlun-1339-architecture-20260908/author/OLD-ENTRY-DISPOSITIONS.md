> 链接转换阅读版；正文语义与原稿一致。签署原字节：[原稿](../../../../payload/sources/newchanlun-1339-architecture-20260908/author/OLD-ENTRY-DISPOSITIONS.md)，SHA256 `b140fda52275c7ef6614c48e323cf0a3033bab1356d39e9a499c29926c7b7b10`。当前批准状态见归档根APPROVAL.json；原稿中的待审状态保留为发生时记录。
...
旧实现行为依据是已封存 [SCAN-DELIVERY](../../../../EXTERNAL-REFERENCES.md#ext-013) 指定的 [canonical 当前入口/消费者登记](../../../../EXTERNAL-REFERENCES.md#ext-014)，登记 SHA-256 为 `fd2547944345274391c72f516bb90de0c4c8ace41dc084757af77723efc7376f`。这是冻结静态证据，未据此推断当前部署。
