> 链接转换阅读版；正文语义与原稿一致。签署原字节：[原稿](../../../../payload/sources/newchanlun-1339-architecture-20260908/author/independent-design-classification-integration.md)，SHA256 `37b91d6fe61ad508e06a733b9972834bb61957f9249be8a612f7d33aa8157dd0`。当前批准状态见归档根APPROVAL.json；原稿中的待审状态保留为发生时记录。
...
完整域、逐叶/公式族、来源与合法转换原文在绑定 [目录](../../../../payload/sources/newchanlun-1339-architecture-20260908/author/CLASSIFICATION-CATALOG.json)；本附录指定它们在新生产架构中的计算、持久输出与验证责任。下面每一行均对应同号目录条目，不能按当前数据有无实例裁剪。
