> 链接转换阅读版；正文语义与原稿一致。签署原字节：[原稿](../../payload/spec/IMPLEMENTATION-CROSSWALK.md)，SHA256 `028ac941954f31bc41ca20813c8b20de903dac199f39709f45115427b131093f`。当前批准状态见归档根APPROVAL.json；原稿中的待审状态保留为发生时记录。
...
完整 JSON 包含原需求/分类轴、证明/同步义务、切片与Destination聚合门、成功闭合说明及未执行状态：[IMPLEMENTATION-CROSSWALK.json](../../payload/spec/IMPLEMENTATION-CROSSWALK.json)。
