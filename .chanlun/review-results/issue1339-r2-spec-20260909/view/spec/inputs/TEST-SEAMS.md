> 链接转换阅读版；正文语义与原稿一致。签署原字节：[原稿](../../../payload/spec/inputs/TEST-SEAMS.md)，SHA256 `2b7a59947390dd3c1d4e4de132c714f330acfbe2890a049527226d787a1e1a6f`。当前批准状态见归档根APPROVAL.json；原稿中的待审状态保留为发生时记录。
...
入口/测试：[main](../../../../../../rust/src/bin/theta_accept.rs)；[run_symbol](../../../../../../rust/src/bin/theta_accept.rs)；[SymbolReport::verdict](../../../../../../rust/src/bin/theta_accept.rs)
...
入口/测试：[replay](../../../../../../rust/src/theta_v0/backtest/replay_dump.rs)；[run_replay_double](../../../../../../rust/src/theta_v0/backtest/replay_dump.rs)
...
入口/测试：[replay_vs_batch_signal_surface_bit_exact_and_report](../../../../../../rust/src/theta_v0/backtest/theta_pi_diff.rs)；[expected_diff_rules_are_machine_encoded](../../../../../../rust/src/theta_v0/backtest/theta_pi_diff.rs)；[diff_engine_flags_unexpected_state_divergence](../../../../../../rust/src/theta_v0/backtest/theta_pi_diff.rs)；[replay_vs_batch_structured_report](../../../../../../rust/src/theta_v0/backtest/theta_pi_diff.rs)
...
入口/测试：[six_state_bot_parity](../../../../../../rust/src/theta_v0/classifier/six_state.rs)；[six_state_inside_parity](../../../../../../rust/src/theta_v0/classifier/six_state.rs)；[six_state_above_no3b_parity](../../../../../../rust/src/theta_v0/classifier/six_state.rs)；[six_state_above_b3_parity](../../../../../../rust/src/theta_v0/classifier/six_state.rs)；[six_state_below_no3s_parity](../../../../../../rust/src/theta_v0/classifier/six_state.rs)；[six_state_below_s3_parity](../../../../../../rust/src/theta_v0/classifier/six_state.rs)；[six_state_exhaustive_and_bot_dimension](../../../../../../rust/src/theta_v0/classifier/six_state.rs)；[signal_2b3b_coexist_parity](../../../../../../rust/src/theta_v0/classifier/six_state.rs)；[signal_1b2b_exclusive_parity](../../../../../../rust/src/theta_v0/classifier/six_state.rs)
...
入口/测试：[append_only_revisions_keep_identity_and_clocks_and_same_as_of_is_idempotent](../../../../../../rust/src/theta_v0/classifier/cand_event/book.rs)；[confirmed_clock_uses_first_observation_as_of_not_geometry_clock](../../../../../../rust/src/theta_v0/classifier/cand_event/book.rs)；[interval_shrink_appends_invalidation](../../../../../../rust/src/theta_v0/classifier/cand_event/book.rs)；[disappearance_appends_invalidation_and_terminal_never_revives](../../../../../../rust/src/theta_v0/classifier/cand_event/book.rs)；[same_key_transitions_unresolved_to_provisional_and_pins_first_provable_clock](../../../../../../rust/src/theta_v0/classifier/cand_event/book.rs)；[first_provable_clock_survives_fallback_to_unresolved](../../../../../../rust/src/theta_v0/classifier/cand_event/book.rs)；[rule_version_bump_mints_new_key_and_never_revives_terminal_one](../../../../../../rust/src/theta_v0/classifier/cand_event/book.rs)
...
入口/测试：[append_only_prefix_and_completed_freeze_reject_write](../../../../../../rust/src/theta_v0/classifier/level_view_store.rs)；[reopen_and_replay_twice_are_idempotent](../../../../../../rust/src/theta_v0/classifier/level_view_store.rs)；[legacy_v0_migrates_on_reopen](../../../../../../rust/src/theta_v0/classifier/level_view_store.rs)
...
入口/测试：[TestWsLiveConnect.test_connect_with_cache](../../../../../../tests/test_gateway_live.py)；[TestWsLiveDisconnect.test_disconnect_removes_client](../../../../../../tests/test_gateway_live.py)；[TestWsLivePing.test_ping_pong](../../../../../../tests/test_gateway_live.py)；[TestOnLiveBar.test_engine_processes_bar](../../../../../../tests/test_gateway_live.py)；[TestLiveEngineReuse.test_engine_reused](../../../../../../tests/test_gateway_live.py)；[TestLiveStatusEndpoint.test_status_reflects_connected_client](../../../../../../tests/test_gateway_live.py)
...
入口/测试：[posted_margin_symmetric_legs_full_polarity](../../../../../../rust/src/theta_v0/strategy/chong.rs)；[net_savings_not_deployable](../../../../../../rust/src/theta_v0/strategy/chong.rs)；[cost_state_not_in_key](../../../../../../rust/src/theta_v0/strategy/chong.rs)；[register_independent_quota_fail_loud](../../../../../../rust/src/theta_v0/strategy/chong.rs)；[single_chong_degenerates_to_account_net](../../../../../../rust/src/theta_v0/strategy/chong.rs)
...
入口/测试：[TestPersistence.test_bar_cache_roundtrip_and_dedup](../../../../../../tests/test_trading_system_skeleton.py)；[TestPersistence.test_crash_recovery_replay_matches_snapshot](../../../../../../tests/test_trading_system_skeleton.py)；[TestPersistence.test_recovery_mismatch_fails_fast](../../../../../../tests/test_trading_system_skeleton.py)；[TestPersistence.test_trade_journal_signal_and_order_lifecycle](../../../../../../tests/test_trading_system_skeleton.py)
...
入口/测试：[TradeJournal.log_fill](../../../../../../trading_system/persistence/trade_journal.py)；[TradeJournal.upsert_voice_state](../../../../../../trading_system/persistence/trade_journal.py)；[TradeJournal.total_position](../../../../../../trading_system/persistence/trade_journal.py)
...
入口/测试：[ThetaRecStrategy.on_bar](../../../../../../trading_system/strategy/theta_rec_strategy.py)；[ThetaRecStrategy._nav](../../../../../../trading_system/strategy/theta_rec_strategy.py)；[ThetaRecStrategy._rebalance](../../../../../../trading_system/strategy/theta_rec_strategy.py)；[ThetaRecStrategy.on_stop](../../../../../../trading_system/strategy/theta_rec_strategy.py)
...
入口/测试：[main](../../../../../../trading_system/live/runner.py)；[__main__](../../../../../../trading_system/live/runner.py)
