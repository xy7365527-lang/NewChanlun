...
| COIN | 19595 | 1616 | 3 | 0 | 0/0 | 1.0 |
| GME | 16404 | 1397 | 96 | 2 | 1/2 | 0.083 |
| AMC | 16058 | 715 | 5 | 1 | 0/0 | 0.25 |
...
| 品种 | n_centers rate | trend_kinds rate | beta1_tau rate |
|------|---------------|-----------------|---------------|
| AAPL | 0.0 | 0.333 | 0.0 |
| MSFT | 0.0 | 0.333 | 0.0 |
| GOOGL | 0.0 | 0.0 | 0.0 |
| AMZN | 0.333 | 0.333 | 0.333 |
| META | 0.0 | 0.0 | 0.0 |
| NVDA | 0.0 | 0.0 | 0.0 |
| AMD | 0.0 | 0.0 | 0.0 |
| TSLA | 0.0 | 0.0 | 0.0 |
...
| RIVN | 0.0 | 0.333 | 0.0 |
| QQQ | 0.0 | 0.0 | 0.0 |
| IWM | 0.333 | 0.333 | 0.333 |
| XLF | 0.0 | 0.0 | 0.0 |
| GLD | 0.333 | 0.333 | 0.333 |
| SPY | 0.0 | 0.0 | 0.0 |

强不变量 mean rate：n_centers=0.167, trend_kinds=0.217, beta1_tau=0.167
完全保持（三项均=1.0）：MARA, COIN（2/20=10%，均为低线段数标的）
部分保持（至少一项>0）：AMZN, IWM, GLD, AMC, AAPL, MSFT, GME, RIVN（8/20=40%）
零保持（三项均=0）：10/20=50%
...
- depth=0 标的：COIN（3 线段）、SOFI（1 线段）——线段数不足以构建 Level 1
...
- T8：53/81 passed（65.4%），0 inconclusive
- 强不变量 mean rate：n_centers=0.167, trend_kinds=0.217, beta1_tau=0.167
- 完全保持 2/20（10%），部分保持 8/20（40%），零保持 10/20（50%）
