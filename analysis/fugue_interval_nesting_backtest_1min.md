...
基线：persistence过滤版。叠加区间套精确进出场：

- **进场**：操作级别BSP确认后，等短差级别buy BSP+L0确认再买入
- **出场**：段间比较确认退出后，等短差级别sell BSP+L0确认再卖出
- **超时fallback**：等待超过60bars用当前价执行
- L2翻空/BSP invalidate仍然立即退出（不等短差级别）
...
| 23 | 582.25@566235 | 601.49@588515 | 22,280 | +5.06 | 2 | 18 | 2 | bsp_invalidate | ENTRY→EVAL→HOLDING→WAIT_DIP→WAIT_SUB_ENTRY |
...
| 2 | 24.54@47223 | 20.33@50552 | 3,329 | -8.73 | 1 | 3 | 1 | bsp_invalidate | ENTRY→EVAL→HOLDING→WAIT_DIP→WAIT_SUB_ENTRY |
| 3 | 27.15@53192 | 19.57@57372 | 4,180 | +0.12 | 2 | 6 | 1 | bsp_invalidate | ENTRY→EVAL→HOLDING→WAIT_DIP→WAIT_SUB_ENTRY |
| 4 | 32.57@82333 | 54.69@94200 | 11,867 | +48.34 | 5 | 9 | 2 | bsp_invalidate | ENTRY→EVAL→HOLDING→WAIT_DIP→WAIT_SUB_ENTRY |
| 5 | 64.15@151396 | 65.64@151540 | 144 | +2.32 | 0 | 0 | 0 | bsp_invalidate | ENTRY→HOLDING→WAIT_SUB_ENTRY |
| 6 | 75.00@173754 | 76.68@178964 | 5,210 | +2.37 | 4 | 4 | 1 | bsp_invalidate | ENTRY→EVAL→HOLDING→WAIT_DIP→WAIT_SUB_ENTRY |
...
| 50,377 | 21.56 | HOLDING | TRIM@21.56 shares=3491.8 |
| 50,507 | 20.36 | HOLDING | ADD_POS@20.36 +961.6 L1ratio=0.236 |
...
| 55,122 | 22.74 | HOLDING | TRIM@22.74 shares=4944.2 |
| 55,491 | 23.99 | HOLDING | CLOSE_DIFF@23.99 profit=-6180.23 |
| 56,100 | 23.94 | HOLDING | TRIM@23.94 shares=4944.2 |
| 56,142 | 23.71 | HOLDING | CLOSE_DIFF@23.71 profit=1137.16 |
| 56,427 | 24.00 | HOLDING | TRIM@24.00 shares=4944.2 |
| 56,700 | 21.99 | HOLDING | CLOSE_DIFF@21.99 profit=9937.81 |
| 56,759 | 22.40 | HOLDING | TRIM@22.40 shares=4944.2 |
| 57,138 | 18.72 | HOLDING | ADD_POS@18.72 +1745.5 L1ratio=0.351 |
...
| 89,466 | 46.55 | HOLDING | TRIM@46.55 shares=7375.0 |
| 90,008 | 45.95 | HOLDING | CLOSE_DIFF@45.95 profit=4424.98 |
| 91,119 | 48.95 | HOLDING | TRIM@48.95 shares=6685.2 |
| 91,475 | 48.63 | HOLDING | CLOSE_DIFF@48.63 profit=2105.85 |
| 92,285 | 54.89 | HOLDING | TRIM@54.89 shares=7249.8 |
| 92,312 | 55.20 | HOLDING | CLOSE_DIFF@55.20 profit=-2247.44 |
| 92,466 | 54.30 | HOLDING | TRIM@54.30 shares=7249.8 |
| 93,016 | 52.38 | HOLDING | CLOSE_DIFF@52.38 profit=13883.39 |
| 93,454 | 50.88 | HOLDING | TRIM@50.88 shares=6778.4 |
| 93,772 | 52.73 | HOLDING | CLOSE_DIFF@52.73 profit=-12506.14 |
...
| 94,086 | 54.37 | HOLDING | ADD_POS@54.37 +1757.1 L1ratio=0.197 |
...
| 174,693 | 76.95 | HOLDING | ADD_POS@76.95 +97.9 L1ratio=0.073 |
| 175,060 | 74.46 | HOLDING | TRIM@74.46 shares=1389.9 |
| 175,622 | 75.20 | HOLDING | CLOSE_DIFF@75.20 profit=-1028.54 |
| 176,091 | 71.38 | HOLDING | MOVE_SETTLE_SKIP(p=7.32<med=7.93) |
| 176,122 | 71.57 | HOLDING | MOVE_SETTLE_SKIP(p=7.32<med=7.93) |
| 176,234 | 71.40 | HOLDING | TRIM@71.40 shares=1338.8 |
| 176,398 | 75.80 | HOLDING | CLOSE_DIFF@75.80 profit=-5883.93 |
| 176,627 | 75.22 | HOLDING | ADD_POS@75.22 +155.4 L1ratio=0.109 |
| 176,907 | 77.59 | HOLDING | ADD_POS@77.59 +172.2 L1ratio=0.109 |
| 177,024 | 77.30 | HOLDING | TRIM@77.30 shares=1753.4 |
| 178,300 | 71.49 | HOLDING | MOVE_SETTLE_SKIP(p=9.23<med=74.93) |
| 178,793 | 76.59 | HOLDING | ADD_POS@76.59 +239.2 L1ratio=0.136 |
...
| # | 入场 | 出场 | 持仓bars | PnL% | 加仓 | 短差 | 向上段数 | 退出原因 | 状态路径 |
|---|------|------|---------|------|------|------|---------|---------|---------|
| 1 | 50.40@289490 | 80.70@375243 | 85,753 | +77.06 | 2 | 9 | 5 | consolidation_divergence | ENTRY→EVAL→HOLDING→WAIT_DIP→WAIT_SUB_ENTRY→WAIT_SUB_EXIT |
...
| 10 | 312.50@685297 | 351.40@704079 | 18,782 | +11.30 | 1 | 6 | 1 | bsp_invalidate | ENTRY→EVAL→HOLDING→WAIT_DIP→WAIT_SUB_ENTRY |
...
| 329,386 | 50.00 | HOLDING | ADD_POS@50.00 +444.0 L1ratio=0.188 |
| 331,116 | 50.30 | HOLDING | TRIM@50.30 shares=2704.7 |
| 334,063 | 55.10 | HOLDING | CLOSE_DIFF@55.10 profit=-12982.68 |
| 336,793 | 55.40 | HOLDING | TRIM@55.40 shares=2796.2 |
| 338,777 | 55.50 | HOLDING | CLOSE_DIFF@55.50 profit=-279.62 |
| 340,518 | 51.70 | HOLDING | TRIM@51.70 shares=2568.3 |
| 341,695 | 55.50 | HOLDING | CLOSE_DIFF@55.50 profit=-9759.45 |
...
| 343,058 | 56.70 | HOLDING | TRIM@56.70 shares=2752.6 |
| 343,399 | 56.10 | HOLDING | CLOSE_DIFF@56.10 profit=1651.56 |
| 352,110 | 68.50 | HOLDING | TRIM@68.50 shares=2628.3 |
| 352,332 | 67.70 | HOLDING | CLOSE_DIFF@67.70 profit=2102.65 |
| 352,795 | 68.70 | HOLDING | TRIM@68.70 shares=2788.5 |
| 355,033 | 66.20 | HOLDING | CLOSE_DIFF@66.20 profit=6971.19 |
...
| 364,770 | 76.90 | HOLDING | TRIM@76.90 shares=2766.9 |
| 367,580 | 78.70 | HOLDING | CLOSE_DIFF@78.70 profit=-4980.38 |
| 368,642 | 77.30 | HOLDING | TRIM@77.30 shares=2617.1 |
| 372,638 | 75.70 | HOLDING | CLOSE_DIFF@75.70 profit=4187.43 |
...
| 7. persistence过滤版（基线） | +58.7% | +194.4% | +313.0% |
| 7+D2. **+区间套定位（本版）** | **+60.7%** | **+192.4%** | **+325.3%** |
...
|------|------|-----|------|------|--------|--------|------|--------|-----|--------|------|
| QQQ | 728,030 | +174.6 | +60.68 | 71% | 28 | 14 | 20/28 | 24/28 | 0/28 | 5/28 | 366s |
| OKLO | 333,613 | +251.3 | +192.44 | 89% | 9 | 7 | 7/9 | 7/9 | 0/9 | 1/9 | 72s |
| HK700 | 1,408,882 | +3933.5 | +325.33 | 71% | 14 | 5 | 14/14 | 14/14 | 0/14 | 1/14 | 524s |
...
- 操作级别确认方向，短差级别精确定位价位
- 进场：操作级别buy BSP后等短差buy BSP+L0确认
- 出场：段间比较确认后等短差sell BSP+L0确认

**边界条件**：
- PENDING_EXPIRY = 390 bars
- SUB_EXPIRY = 60 bars（短差等待上限）
- L2翻空/BSP invalidate不等短差，立即退出

**下游推论**：
- 若区间套版 > 基线 → 短差级别定位确实改善进出场价位
- 若区间套版 < 基线 → 等待短差引入了延迟成本（价格跑掉了）
- 区间套改善的方向（进场更低/出场更高）可从改善统计验证
