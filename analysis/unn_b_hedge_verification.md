> ⚠️ **已扬弃（谱系记录）**：本 commit（c6deae8780）的"否定线⇒降成本对冲"被编排者 2026-06-15
> 否定——"仍是在补丁上加补丁，保留了否定线这个非必然触发器"。否定线本身是经验性补丁（非概念
> 运动链推论），已在后续 commit 整个删除。见 `unn_negate_line_deletion.md`。本文保留为补丁四次
> 否定序列的谱系记录（df752ea6e4→6faf4ec45a→**本 commit**→否定线删除）。
