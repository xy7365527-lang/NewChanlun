...
> **订正（#512 / #511 MED，2026-07-28）**：本报告 §2（原 :76-97）、§6（原
> :262-273）及 §13.8 的臂 D 旧读数均早于 #446 活动集同 `ElementId` 双 idx 修复，现已
> **superseded**；不得继续作为当前代码态基线。修复后九窗唯一权威为
> `treasury-reverify-20260727.md` §15.1/§15.2。例：wf8 臂 D 的
> `net_r(execR) / R(含浮盈)` 由旧 `+4504490 / +4980320` 订正为
> `+4463727 / +4938316`。三窗当前对照如下；其余 orders/LEE/LCB/三态字段一律回查 T3
> §15.1/§15.2，不从本报告旧表增量继承：
>
> | 窗 | 旧 D `net_r / R`（本报告历史证词） | 修复后 D `net_r / R`（T3 §15.2） | 状态 |
> |---|---:|---:|---|
> | p3fold | `-1630887 / -1564400` | `-1341964 / -1275888` | **superseded** |
> | wf7 | `-6363805 / -6113276` | `-5840660 / -5586255` | **superseded** |
> | wf8 | `+4504490 / +4980320` | `+4463727 / +4938316` | **superseded** |
