...
> 状态：正式规范 v1.0（经 /ritual 结算）
> 日期：2026-02-18
> 前置：ontology-v1.md 命题5, move_rules_v1.md, zhongshu_rules_v1.md
> 溯源：[旧缠论] 比价关系为三个独立系统之一，其变动构成独立买卖系统（第9/72/73课）；[旧缠论:隐含] 比价K线构造（A/B除法）；[新缠论] 等价关系严格定义 + 四矩阵拓扑
...
买卖系统 = 独立的缠论分析系统。比价K线上的缠论结构携带**资本流转**语义：
...
> **047号谱系**：现金顶点的完整定义为"主权信用/流动性复合体"
> （Sovereign Credit / Liquidity Complex），包含现金(M0/M1)和
> 固定收益/国债。货币即主权债务，区别仅在久期。CASH 内部的
> 现金/债券轮动属于 Level 2（内部结构），不在拓扑层处理。
> 期限利差交易场景需启用子系统。
...
| 概念 | 溯源 | 原文出处 |
|------|------|---------|
| 比价关系（三个独立系统之一） | [旧缠论] | 第9/72/73课 |
| 比价变动构成独立买卖系统 | [旧缠论] | 第9课："比价关系的变动，也可以构成一个买卖系统" |
| 比价与资金流向相关 | [旧缠论] | 第9课："这个买卖系统是和市场资金的流向相关的" |
| A/B 直接除构造比价K线 | [旧缠论:隐含] | 原文隐含（买卖系统需要K线，比价变动的K线化是逻辑必然） |
| 比价走势语义（资本流转） | [旧缠论:隐含] | 从"资金流向"推出 |
| 等价关系严格定义 | [新缠论] | 本规范首次形式化 |
