...
//!
//! 本文件把 backtest-protocol-v0.md §2 的切分规则具体化为 10 品种精确日期窗口常量。
...
/// 10 品种预注册窗口（冻结，顺序 = 核心 BTC/ES/CL/GC → 扩展 BRN/DX/QQQ/ZN/6E → 观察 OKLO）。
pub const PREREG_WINDOWS: &[SymbolWindows] = &[
    ...
    SymbolWindows {
        symbol: "ZN",
        pool: Pool::Extended,
        data_start: "2010-06-07",
        data_end: "2026-06-05",
        is_window: Some(("2010-06-07", "2022-12-31")),
        oos: ("2023-01-01", "2025-06-30"),
        holdout: Some(("2025-07-01", "2026-06-05")),
        wf_anchored: &[
            WfWindow {
                i: 0,
                train_start: "2010-06-07",
                train_end: "2012-06-06",
                test_start: "2012-06-07",
                test_end: "2012-12-06",
                clipped: false,
            },
            WfWindow {
                i: 1,
                train_start: "2010-06-07",
                train_end: "2012-12-06",
                test_start: "2012-12-07",
                test_end: "2013-06-06",
                clipped: false,
            },
            WfWindow {
                i: 2,
                train_start: "2010-06-07",
                train_end: "2013-06-06",
                test_start: "2013-06-07",
                test_end: "2013-12-06",
                clipped: false,
            },
            WfWindow {
                i: 3,
                train_start: "2010-06-07",
                train_end: "2013-12-06",
                test_start: "2013-12-07",
                test_end: "2014-06-06",
                clipped: false,
            },
            WfWindow {
                i: 4,
                train_start: "2010-06-07",
                train_end: "2014-06-06",
                test_start: "2014-06-07",
                test_end: "2014-12-06",
                clipped: false,
            },
            WfWindow {
                i: 5,
                train_start: "2010-06-07",
                train_end: "2014-12-06",
                test_start: "2014-12-07",
                test_end: "2015-06-06",
                clipped: false,
            },
            WfWindow {
                i: 6,
                train_start: "2010-06-07",
                train_end: "2015-06-06",
                test_start: "2015-06-07",
                test_end: "2015-12-06",
                clipped: false,
            },
            WfWindow {
                i: 7,
                train_start: "2010-06-07",
                train_end: "2015-12-06",
                test_start: "2015-12-07",
                test_end: "2016-06-06",
                clipped: false,
            },
            WfWindow {
                i: 8,
                train_start: "2010-06-07",
                train_end: "2016-06-06",
                test_start: "2016-06-07",
                test_end: "2016-12-06",
                clipped: false,
            },
            WfWindow {
                i: 9,
                train_start: "2010-06-07",
                train_end: "2016-12-06",
                test_start: "2016-12-07",
                test_end: "2017-06-06",
                clipped: false,
            },
            WfWindow {
                i: 10,
                train_start: "2010-06-07",
                train_end: "2017-06-06",
                test_start: "2017-06-07",
                test_end: "2017-12-06",
                clipped: false,
            },
            WfWindow {
                i: 11,
                train_start: "2010-06-07",
                train_end: "2017-12-06",
                test_start: "2017-12-07",
                test_end: "2018-06-06",
                clipped: false,
            },
            WfWindow {
                i: 12,
                train_start: "2010-06-07",
                train_end: "2018-06-06",
                test_start: "2018-06-07",
                test_end: "2018-12-06",
                clipped: false,
            },
            WfWindow {
                i: 13,
                train_start: "2010-06-07",
                train_end: "2018-12-06",
                test_start: "2018-12-07",
                test_end: "2019-06-06",
                clipped: false,
            },
            WfWindow {
                i: 14,
                train_start: "2010-06-07",
                train_end: "2019-06-06",
                test_start: "2019-06-07",
                test_end: "2019-12-06",
                clipped: false,
            },
            WfWindow {
                i: 15,
                train_start: "2010-06-07",
                train_end: "2019-12-06",
                test_start: "2019-12-07",
                test_end: "2020-06-06",
                clipped: false,
            },
            WfWindow {
                i: 16,
                train_start: "2010-06-07",
                train_end: "2020-06-06",
                test_start: "2020-06-07",
                test_end: "2020-12-06",
                clipped: false,
            },
            WfWindow {
            ...
            WfWindow {
                i: 18,
                train_start: "2010-06-07",
                train_end: "2021-06-06",
                test_start: "2021-06-07",
                test_end: "2021-12-06",
                clipped: false,
            },
            WfWindow {
                i: 19,
                train_start: "2010-06-07",
                train_end: "2021-12-06",
                test_start: "2021-12-07",
                test_end: "2022-06-06",
                clipped: false,
            },
            WfWindow {
                i: 20,
                train_start: "2010-06-07",
                train_end: "2022-06-06",
                test_start: "2022-06-07",
                test_end: "2022-12-06",
                clipped: false,
            },
            WfWindow {
            ...
            WfWindow {
                i: 23,
                train_start: "2010-06-07",
                train_end: "2023-12-06",
                test_start: "2023-12-07",
                test_end: "2024-06-06",
                clipped: false,
            },
            WfWindow {
            ...
            WfWindow {
                i: 25,
                train_start: "2010-06-07",
                train_end: "2024-12-06",
                test_start: "2024-12-07",
                test_end: "2025-06-06",
                clipped: false,
            },
            WfWindow {
...
mod tests {
    ...
    /// 结构不变量：10 品种，池角色分布正确（核心 4 / 扩展 5 / 观察 1）。
    #[test]
    fn prereg_consistency_pool_counts() {
        assert_eq!(PREREG_WINDOWS.len(), 10, "10 品种（§1.1 + §9 补录 ZN/6E）");
        ...
        assert_eq!(
            (core, ext, obs),
            (4, 5, 1),
            "核心4/扩展5/观察1（§1.3 + §9 补录 ZN/6E）"
        );
    }

    /// 全局 OOS 统一性：核心+扩展池 9 品种 OOS 边界一致（§2.1）。
    #[test]
