//! 三态状态机 + 成立档开具点 + 警报计数（票 #621 S1 第二、四段；成立档门户类型
//! [`CenterDeathCertificate`] / [`ThirdPointPack`] 票 #765 纯移动迁出至 [`super::established`]）。
//!
...
use super::established::{CenterDeathCertificate, ThirdPointPack};
...
use super::{
    ...
    RetraceOutcome, RetracePolicy, RetraceRevision, RetraceRevisionKind, RetraceState,
};
