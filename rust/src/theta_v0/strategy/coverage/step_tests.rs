...
fn duplicate_active_id_panics_with_id_indices_and_sources_in_release() {
    ...
    let hit_512_release_guard = message
        .contains("重复 ElementId ElementId { level: 0, ordinal: 777 }")
...
fn risk_seed_carrier_ambiguous_span_fails_closed() {
    ...
    assert_eq!(
        ancok_probe_snapshot().risk_seed_carrier_ambiguous,
        1,
