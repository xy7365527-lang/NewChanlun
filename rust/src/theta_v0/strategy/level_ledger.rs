...
mod tests {
    ...
    fn mirror_rows_bit_equal_overlay_rows() {
        ...
        let t0 = [
            ...
            leg(c, VoiceSide::Short, 6.0, Vertical::ReverseOpen),
        ];
    ...
    fn level_nets_matches_mirror_nets_single_source() {
        let batches: Vec<Vec<SepLeg>> = vec![
            ...
            vec![
                ...
                leg(eid(1, 0), VoiceSide::Short, 6.0, Vertical::ReverseOpen),
            ...
            vec![
                ...
                leg(eid(2, 1), VoiceSide::Short, 5.0, Vertical::ReverseOpen),
            ],
        ];
        for legs in &batches {
            let mut ll = LevelLedgerMirror::new();
    ...
    fn same_carrier_duplicate_legs_accumulate_like_overlay() {
        ...
        let dup = [
            leg(eid(1, 0), VoiceSide::Long, 4.0, Vertical::Ambient),
            leg(eid(1, 0), VoiceSide::Short, 6.0, Vertical::ReverseOpen), // 同 carrier 第二条
        ];
