...
def _emit_lzs_invalidate(
    _append: Callable[..., None], i: int, zs: LevelZhongshu,
) -> None:
    """发射 LevelZhongshu InvalidateV1 事件。"""
    _append(
        ZhongshuInvalidateV1,
        zhongshu_id=i,
        zd=zs.zd,
...
def diff_level_zhongshu(
    ...
    *,
    ...
    return diff_by_prefix(
        ...
        bar_ts=bar_ts,
        seq_start=seq_start,
        equal_fn=_level_zhongshu_equal,
        same_identity_fn=_same_level_zhongshu_identity,
        emit_invalidate=_emit_lzs_invalidate,
        handle_same_identity=_handle_lzs_same_identity,
        handle_new=_handle_lzs_new,
        extra_kwargs={"level_id": level_id},
    )
...
def _emit_level_move_invalidate(
    _append: Callable[..., None], i: int, m: Move,
) -> None:
    """发射 Level MoveInvalidateV1 事件。"""
    _append(
        MoveInvalidateV1,
        move_id=i,
        kind=m.kind,
...
def diff_level_moves(
    ...
    *,
    ...
    return diff_by_prefix(
        ...
        bar_ts=bar_ts,
        seq_start=seq_start,
        equal_fn=_level_move_equal,
        same_identity_fn=_same_level_move_identity,
        emit_invalidate=_emit_level_move_invalidate,
        handle_same_identity=_handle_level_move_same_identity,
        handle_new=_handle_level_move_new,
        extra_kwargs={"level_id": level_id},
    )
