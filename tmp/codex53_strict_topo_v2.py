#!/usr/bin/env python3
"""Call Codex 5.3 High via responses API for strict topologization discussion."""
...
**重要：如果你同意 Gemini 的某个评估，请明确说"同意"并说明理由。如果你不同意，请给出具体的反例或替代论证。**"""

print("Calling Codex 5.3 High via responses API...")
response = client.responses.create(
    model="gpt-5.3-codex",
    reasoning={"effort": "high"},
    input=DISCUSSION_PROMPT,
)
